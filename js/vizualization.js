(function () {
    ...
    function generateCircles() {
        let svg = d3.select("#circle-25-percent")
            .append("svg")
            .attr("height", 200)
            .attr("width", 200);
        ...
        svg.append("foreignObject")
            ...
            .attr("x", 25)
            .attr("y", -900)
            .attr("class", "circle-body")
            .append("xhtml:div").html("Android users retained within 24 hours of app installation<sup> [3]</sup>");
        ...
        svg.append("circle")
            ...
            .on("mouseover", function (d) {
                ...
                filter
                    ...
                    .duration(500)
                    .attr("stdDeviation", 0);
                d3.select(".circle-header")
                    .transition()
                    .duration(500)
                    .attr("y", 75);
                d3.select(".circle-body")
                    .transition()
                    .attr("y", 90);
                d3.select(".circle-body div")
                    .transition()
                    .duration(1000)
                    .style("opacity", 1);
            })
    ...
    function generateWorldMap() {
        ...
        generateWorldMapDetails(svg, projection);

        generateLocationFilter(svg);
    }

    let activeLocationFilter = "All";
    function generateLocationFilter(svg) {

        let locationFilterG = svg.append("g")
            .attr("transform", "translate(0,15)")
            .attr("class", "");

        locationFilterG.append("rect")
            .attr("height", 30)
            .attr("width", 300)
        ...
        locationFilterG
            .append("text")
            .text("Location")
            .attr("class", "filtertxt")
            .attr("x", 20)
            .attr("y", 5);

        locationFilterG.append("line")
            .attr("class", "filter-separator")
            .attr("x1", 90)
            .attr("y1", -10)
            .attr("x2", 90)
            .attr("y2", 10);

        let dropdownData = ["All", "North America", "Europe", "APAC", "LATAM", "Middle East", "Africa"];
        locationFilterG.append("text")
            .text("All")
            .attr("class", "dropdownSelected")
            .attr("x", 120)
            .attr("y", 5);

        let clickG = locationFilterG.append("g")
        ...
        locationFilterG.append("rect")
            ...
            .style("fill", "transparent")
            .attr("class", "dropdownActive")
            .attr("x", 120)
            .attr("y", -10)
            .attr("height", 20)
            .attr("width", 165)
            .on("click", function () {
                if (d3.select(this).classed("dropdownClicked")) {
                    d3.select(".dropdownValues")
                        .transition()
                        .duration(200)
                        .style("display", "none");
                } else {
                ...
                d3.select(this).classed("dropdownClicked", !d3.select(this).classed("dropdownClicked"));
            });

        let dropdownG = locationFilterG
            .append("g")
            .attr("class", "dropdownValues");

        dropdownG.append("rect")
            .attr("class", "dropdownBg")
            .attr("x", 100)
            .attr("y", 16)
            .attr("height", 214)
            .attr("width", 185);

        dropdownG.selectAll("line")
            .data(dropdownData)
            .enter()
            .append("line")
            .attr("class", "dropdownSeparator")
            .attr("x1", 120)
            .attr("y1", function (d, i) { return ((i + 2) * 20) + ((i + 1) * 10); })
            .attr("x2", 260)
            .attr("y2", function (d, i) { return ((i + 2) * 20) + ((i + 1) * 10); })

        dropdownG.selectAll("text")
            .data(dropdownData)
            .enter()
            .append("text")
            .text(function (d) { return d; })
            .attr("x", 120)
            .attr("y", function (d, i) { return ((i + 2) * 20) + (i * 10); });

        dropdownG.selectAll(".dropdown-rect-hover")
            .data(dropdownData)
            .enter()
            .append("rect")
            .attr("class", "dropdown-rect-hover")
            .attr("x", 100)
            .attr("y", function (d, i) { return 20 + (i * 30); })
            .attr("height", 30)
            .attr("width", 185)
            .on("click", function (value) {
                d3.select(".dropdownSelected").text(value);
                let className = value.replace(/\s/g, '');
                activeLocationFilter = className;
                d3.select(".citiesG")
                    .selectAll("circle")
                    .transition()
                    .duration(500)
                    .attr("r", function () {
                        return (d3.select(this).classed(className) && (isConsumptionClassed(d3.select(this)))) || className === "All" ? (radius / 2) : 0;
                    });
                ...
                d3.select(".dropdownActive").classed("dropdownClicked", !d3.select(".dropdownActive").classed("dropdownClicked"));
            });

        function isConsumptionClassed(element) {
            let flag = true;
            let consumptionFilters = svg.selectAll(".consumption-active");
            consumptionFilters.nodes().every(item => {
                if (item.textContent === "High" && element.classed("high-consumption")) {
                    flag = true;
                    return false;
                } else if (item.textContent === "Medium" && element.classed("medium-consumption")) {
                    flag = true;
                    return false;
                } else if (item.textContent === "Low" && element.classed("low-consumption")) {
                    flag = true;
                    return false;
                } else {
                    flag = false;
    ...
    function generateComsumptionFilter(svg) {

        let consumptionFilterG = svg.append("g")
            .attr("transform", "translate(525,15)")
            .attr("class", "");

        consumptionFilterG.append("rect")
            .attr("height", 30)
            .attr("width", 400)
            .attr("class", "filter-rect")
            .attr("x", -30)
        ...
        consumptionFilterG
            .append("text")
            .text("Sort by Consumption")
            .attr("class", "filtertxt")
            .attr("x", -10)
            .attr("y", 5);

        consumptionFilterG.append("line")
            .attr("class", "filter-separator")
            .attr("x1", 120)
            .attr("y1", -10)
            .attr("x2", 120)
        ...
        consumptionFilterG
            ...
            .attr("x", 160)
            .attr("y", 5)
            .attr("class", "consumption consumption-active")
            .on("click", function () {
                if (d3.select(this).classed("consumption-active")) {
                    d3.selectAll(".high-consumption")
                        .transition()
                        .duration(200)
                        .attr("r", 0);
                } else {
                    let selectQuery = ".high-consumption";
                    selectQuery += activeLocationFilter !== "All" ? "." + activeLocationFilter : "";
                    d3.selectAll(selectQuery)
                        .transition()
                        .duration(200)
                        .attr("r", radius / 2);
                }
                d3.select(this).classed("consumption-active", !d3.select(this).classed("consumption-active"));
            });

        consumptionFilterG
            .append("circle")
            .attr("class", "medium-consumptionF")
            .attr("cx", 220)
            .attr("cy", 0)
            .attr("r", radius / 2);
        ...
        consumptionFilterG
            ...
            .on("click", function () {
                if (d3.select(this).classed("consumption-active")) {
                    d3.selectAll(".medium-consumption")
                        .transition()
                        .duration(200)
                        .attr("r", 0);
                } else {
                    let selectQuery = ".medium-consumption";
                    selectQuery += activeLocationFilter !== "All" ? "." + activeLocationFilter : "";
                    d3.selectAll(selectQuery)
                        .transition()
                        .duration(200)
        ...
        consumptionFilterG
            ...
            .on("click", function () {
                if (d3.select(this).classed("consumption-active")) {
                    d3.selectAll(".low-consumption")
                        .transition()
                        .duration(200)
                        .attr("r", 0);
                } else {
                    let selectQuery = ".low-consumption";
                    selectQuery += activeLocationFilter !== "All" ? "." + activeLocationFilter : "";
                    d3.selectAll(selectQuery)
                        .transition()
                        .duration(200)
    ...
    function generateWorldMapDetails(svg, projection) {
        svg.append("g")
            .attr("class", "citiesG")
            .attr("transform", "translate(" + -50 + "," + 50 + ")")
            .selectAll("circle")
            ...
            .attr("class", function (d) {
                return d.classname + " " + d.region.replace(/\s/g, '');
            })
            .on("mouseover", function (d, i) {
                var hoverCircle = d3.select("." + d.code);
                hoverCircle.style("opacity", 1);
                hoverCircle.classed("rotateOut", !hoverCircle.classed("rotateOut"));
                d3.select(".hover-details" + d.code)
                    .transition()
                    .duration(100)
        ...
        svg.append("g")
            ...
            .attr("class", function (d) {
                return "consumption-hover animated infinite " + d.code;
            })
            .attr("r", radius * 2);

        let hoverG = svg.append("g")
            .attr("transform", "translate(" + -50 + "," + 50 + ")");

        getCsvData().forEach(function (d) {
            let leftMargin = radius * 4;
            let rectWidth = 250, rectHeight = 125;
            let localG = hoverG.append("g")
                .attr("transform", "translate(" + svgWidth * 2 + ", 0)")
                .attr("class", ("hover-details" + d.code) + " hover-details");

            localG
                .append("rect")
                .attr("class", ("bgrect" + d.code) + " bgrect")
                .attr("x", function () {
                    let newX = (radius / 2);
                    if (d.lon > 50) {
                        newX = newX - rectWidth - 7.5;
                    }
                    return projection([d.lon, d.lat])[0] + newX;
                })
                .attr("y", function () {
                    let newY = (radius / 2);
                    if (d.lat < 0) {
                    ...
                    return projection([d.lon, d.lat])[1] + newY;
                })
            ...
            localG.append("text")
                .text(d.country)
                .attr("class", ("countrytext" + d.code) + " countrytext")
                .attr("x", function () {
                    let newX = leftMargin;
                    if (d.lon > 50) {
                        newX = newX - rectWidth - 7.5;
            ...
            localG.append("text")
                .text(d.region)
                .attr("class", ("regiontext" + d.code) + " regiontext")
                .attr("x", function () {
                    let newX = leftMargin;
                    if (d.lon > 50) {
                        newX = newX - rectWidth - 7.5;
            ...
            localG.append("text")
                .text(d.value)
                .attr("class", ("consumptiontext" + d.code) + " consumptiontext")
                .attr("x", function () {
                    let newX = leftMargin;
                    if (d.lon > 50) {
                        newX = newX - rectWidth - 7.5;
            ...
            localG.append("text")
                .text("Share of video ad")
                .attr("class", ("statictext" + d.code) + " statictext")
                .attr("x", function () {
                    let newX = radius * 18;
                    if (d.value.length > 3) {
                        newX = radius * 23;
            ...
            localG.append("circle")
                ...
                .attr("r", 2.5)
                .attr("class", d.classname === "high-consumption" ? "high-consumptionF" :
                    (d.classname === "medium-consumption" ? "medium-consumptionF" : "low-consumptionF"));
    ...
    function generateWorldMapXs() {
        let element = d3.select(".xs-world-map");
        let svg = element.append("svg")
            .attr("preserveAspectRatio", "xMinYMin meet")
            .attr("viewBox", "0 0 " + svgHeight + " " + (svgWidth * .5));

        let width = (svgHeight) - margin.left - margin.right;
        let height = svgWidth * .5 - (10 * margin.top) - margin.bottom;

        let locationFilterG = svg.append("g")
            .attr("transform", "translate(12.5,15)")
            .attr("class", "");
        ...
        locationFilterG.append("foreignObject")
            .attr("width", 150)
            .attr("x", 110)
            .attr("y", -10)
            .append("xhtml:select")
            .attr("class", "dropdownxs")
            .html(getHtml())
            .on("change", function (d) {
                let selectTag = d3.select(this);
                let selectedIndex = selectTag.property('selectedIndex');
                let selectedCntry = getCsvData()[selectedIndex];
                svg.select(".countrytext").text(selectedCntry.country);
                svg.select(".regiontext").text(selectedCntry.region);
                svg.select(".consumptiontext").text(selectedCntry.value);
                svg.select(".consumptioncir").attr("class", "consumptioncir " + selectedCntry.classname);
            });
        ...
        function getHtml() {
            ...
            getCsvData().forEach((item) => {
                optionTags += "<option>" + item.country + "</option>";
            });
            return optionTags;
        }

        let rectWidth = 325, rectHeight = 200;
        let selectedItemG = svg.append("g").attr("transform", "translate(0,-20)");
        ...
        selectedItemG.append("circle")
            .attr("cx", 275)
            .attr("cy", 130)
            .attr("r", 5)
            .attr("class", "consumptioncir high-consumption");


        let consumptionFilterG = svg.append("g")
            .attr("transform", "translate(12.5,280)")
            .attr("class", "");
    ...
    function programmaticRisingSvgXs() {
        let element = d3.select("#xsProgrammaticRisingSvg");
        let svg = element.append("svg")
            .attr("preserveAspectRatio", "xMinYMin meet")
            .attr("viewBox", "0 0 " + svgHeight + " " + (svgWidth * .4));
    ...
    function topPerformingVerticalsSvgXs() {
        let element = d3.select("#xsTopPerformingVerticalsSvg");
        let svg = element.append("svg")
            .attr("preserveAspectRatio", "xMinYMin meet")
            .attr("viewBox", "0 0 " + svgHeight + " " + (svgWidth * .4));
        ...
        let data = [
            ...
            { "title": "Games", "value1": "165", "value2": "115", "text1": "7.0%", "text2": "4.7%" },
            { "title": "Tech", "value1": "200", "value2": "330", "text1": "8.8%", "text2": "13.3%" },
            { "title": "Entertainment", "value1": "270", "value2": "310", "text1": "9.2%", "text2": "10.7%" },
            { "title": "CPG", "value1": "320", "value2": "235", "text1": "18.9%", "text2": "16.9%" },
            { "title": "Retail", "value1": "480", "value2": "440", "text1": "11.7%", "text2": "7.5%" },
        ];

        generateXs(svg, data);
    }

    function generateXs(svg, data) {

        let width = (svgHeight) - margin.left - margin.right;
        let height = svgWidth * .4 - (10 * margin.top) - margin.bottom;

        let xScale = d3.scaleLinear().rangeRound([width, 0]);
        xScale.domain([0, 700]);

        let legendG = svg.append("g")
            .attr("transform", "translate(0, 0)");

        legendG.append("text").attr("class", "legend").text("Legend:")
            .attr("x", 0)
            .attr("y", 50);
        ...
        legendG.append("text").attr("class", "textBtnDefault").text("Q2 ‘16")
            .attr("x", 70)
            .attr("y", 50);
        ...
        legendG.append("text").attr("class", "textBtnDefault").text("Q1 ‘16")
            .attr("x", 140)
            .attr("y", 50);
        ...
        textg
            ...
            .attr("class", function (d, i) {
                return "ticktxt" + ((i === 3) ? " ticktxtactive" : "");
            })
            .text(function (d) { return d.title; })
            .attr("x", 0)
            .attr("y", function (d, i) { return i * 50 + 7.5; })
            .on("click", function (d) {
                svg.select(".ticktxtactive").classed("ticktxtactive", !svg.select(".ticktxtactive").classed("ticktxtactive"));
                d3.select(this).classed("ticktxtactive", !d3.select(this).classed("ticktxtactive"));
                svg.select(".tvalue1xs").text(d.text1);
                svg.select(".tvalue2xs").text(d.text2);
            });
        ...
        rectg.append("g")
            ...
            .attr("x", 0)
            .attr("y", function (d, i) { return i * 50 + 7.5; })
            .attr("width", function (d) { return width - xScale(d.value2); })
            .attr("height", 10);
        ...
        rectg.append("g")
            ...
            .attr("width", function (d) { return width - xScale(d.value1); })
            .attr("height", 10);

        let selectedValuesG = svg.append("g").attr("transform", "translate(200,40)");

        selectedValuesG.append("rect")
            .attr("class", "bar-fg1")
            .attr("x", 55)
            .attr("y", 42.5)
            .attr("width", 7.5)
        ...
        selectedValuesG.append("text").attr("class", "tvalue1 tvalue1xs").text("10.4%")
            .attr("x", 70)
            .attr("y", 50)
            .style("opacity", 1);
        ...
        selectedValuesG.append("text").attr("class", "tvalue2 tvalue2xs").text("6.2%")
            .attr("x", 70)
            .attr("y", 80)
            .style("opacity", 1);
